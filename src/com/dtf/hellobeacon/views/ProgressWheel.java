...
public class ProgressWheel extends View {
    ...
    private int contourColor = 0xAAbfbfbf;
    ...
    private void parseAttributes(TypedArray a) {
        ...
        if (a.hasValue(R.styleable.ProgressWheel_valuetext)) {
            setText(a.getString(R.styleable.ProgressWheel_valuetext), a.getString(R.styleable.ProgressWheel_labeltext));
        }
    ...
    */
    ...
    /**
     * Increment the progress by 3 (of 360)
     */
...
//        setText(Math.round(((float) progress / 360) * 100) + "%");
     ...
     */
    public void setText(String valuetext, String labeltext) {
        this.value_text = valuetext;
        splitValueText = this.value_text.split("\n");
        
        this.label_text = labeltext;
        splitLabelText = this.label_text.split("\n");
    }
